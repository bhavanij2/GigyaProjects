// role-permission-relationships/site-manager.cypher
// give Site Manager (sm) MyAccount and Finance permissions
...
MATCH
  (r_seed:Role      {id: 'glb:seed:sm'}),
  (r_bioag:Role     {id: 'glb:bioag:sm'}),
  (r_acceleron:Role {id: 'glb:acceleron:sm'}),
  (r_cp:Role        {id: 'glb:cp:sm'}),
