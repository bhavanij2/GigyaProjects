...
<p><a href="https://my-dekalbasgrowdeltapine.agro.services/portal">https://my-dekalbasgrowdeltapine.agro.services/portal</a></p>
</#if>

<p>If you have any questions, please contact the FarmFlex Credit Team by calling 1-800-335-2676, option 2.</p>', 'Bill Pay Registration Complete');
INSERT INTO public.email_template VALUES ('EMAIL_VERIFICATION', '<p>You''re almost there!</p>
<p>Please click <a href="https://aperture-user-registration.velocity.ag/verify-email/${userId}/${emailVerificationCode}">here</a> to access the final steps of your Bill Pay registration and activate your account.</br>
If you have any questions, please contact the FarmFlex Credit Team by calling 1-800-335-2676, option 2.</p>
<p>Thank you!</p>', 'Complete your Bill Pay Registration');
...
<img style="width:98%; height: auto; margin-left: 1%; margin-right: 1%;" src="https://velocity.ag/self-registration/assets/images/email-header-dad.jpg">
...
<p>DEKALB®, Asgrow® and Deltapine® brands are excited to offer a new, simple online payment system to FarmFlex® Financing customers. Selecting this <a ses:no-track href="https://velocity.ag/self-registration/register/${userId}">link</a> will direct you through the simple registration process!</p>
...
<p style=''font-size: 9.0pt; font-family: "Times New Roman", Times, serif;''>Asgrow and the A Design®, Asgrow®, DEKALB and Design®, DEKALB® and Deltapine® are registered trademarks of Bayer Group. © 2018 Bayer Group. All Rights Reserved.</p>', 'Check out the NEW Online Payment system for FarmFlex® Financing Customers');
INSERT INTO public.email_template VALUES ('NBD_PRE_REGISTRATION_INVITE', '<div style="margin-left: 1%; margin-right: 1%;" >
    <img style="width:98%; height: auto;" src="https://velocity.ag/self-registration/assets/images/mycrop-email-header.jpg">
    <p>Hello,</p>
    <p>
    ...
    <p>
        Please take a moment and register <strong><a ses:no-track
                                                     href="https://velocity.ag/self-registration/register/${userId}">here</a></strong>. Please also
        bookmark
...
<p>Bayer is a registered trademark of Bayer Group. ©2019 Bayer Group. All rights reserved.</p>', 'MyCROP - Thank You for Registering');
